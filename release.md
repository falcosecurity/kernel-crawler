...
4. Once the CI has done its job, the tag is live on Github, and the container image is live on [DockerHub](https://hub.docker.com/r/falcosecurity/kernel-crawler) with proper tags
